...
class TeamMember(models.Model):
    ...
    #college_id = models.CharField(_('college id'),max_length=5, validators=[RegexValidator(r'^[0-9]{5,5}$', 'Invalid College ID'),], required= False)
...
class UploadFileModel(models.Model):
    ...
    question_no = models.IntegerField()
    file = models.FileField(upload_to='coding_files/', null=True, blank=True)
    team = models.ForeignKey(Team, on_delete=models.CASCADE)
